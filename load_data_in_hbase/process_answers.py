...
df = spark.read.format('csv').option('header', 'true').option('mode', 'DROPMALFORMED').load('hdfs://sandbox-hdp.hortonworks.com:8020/local-dir/cca_498_final_project/raw_data/full/Answers_New.csv')
